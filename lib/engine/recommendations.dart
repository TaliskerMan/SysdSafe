...
class RecommendationEngine {
  static final Map<String, HardeningAdvice> _matrix = {
    ...
    'ProtectControlGroups': HardeningAdvice(
      ...
      humanAdvice:
          'Safe for most services unless it is a container manager like Docker.',
    ...
    'ProtectKernelLogs': HardeningAdvice(
      ...
      humanAdvice:
          'Safe for almost all services. Prevents reading kernel logs.',
    ...
    'RestrictRealtime': HardeningAdvice(
      ...
      humanAdvice:
          'Safe for most services except specific audio or extreme low-latency apps.',
    ...
    'PrivateNetwork': HardeningAdvice(
      ...
      humanQuestion:
          'Does this service need to connect to the internet or local network?',
      humanAdvice:
          'If NO: Apply this immediately. It completely isolates the service from the network. (Do NOT apply to network services like nginx, sshd).',
    ...
    'ProtectHome': HardeningAdvice(
      ...
      humanQuestion:
          'Does this service need to read or write to user home directories?',
      humanAdvice:
          'If NO: Apply this. It makes /home and /root inaccessible. Very important for stopping data exfiltration.',
    ...
    'ProtectSystem': HardeningAdvice(
      ...
      humanQuestion:
          'Does this service need to modify system files in /usr or /etc?',
      humanAdvice:
          'If NO: Apply this. It mounts /usr and /boot (and /etc if set to "strict") read-only.',
    ...
    'PrivateTmp': HardeningAdvice(
      ...
      humanAdvice:
          'If YES: Apply this. Prevents the service from seeing or tampering with temporary files of other users/services.',
    ...
    'RestrictNamespaces': HardeningAdvice(
      ...
      humanQuestion:
          'Does this service spawn containers or complex namespaces?',
      humanAdvice:
          'If NO: Apply this. It prevents the service from creating new Linux namespaces.',
    ...
    'DynamicUser': HardeningAdvice(
      ...
      humanAdvice:
          'Warning: This dynamically allocates a user. Files created will be owned by this dynamic user, which might complicate file sharing. Excellent for stateless daemons.',
    ...
    'SystemCallFilter': HardeningAdvice(
      ...
      humanAdvice:
          'Warning: This requires knowing exactly what syscalls the app needs. Blocking @clock, @module, or @mount is generally safe for non-system tools.',
    ...
    'RestrictAddressFamilies': HardeningAdvice(
      ...
      humanAdvice:
          'Warning: Typically you only want to allow AF_UNIX, AF_INET, and AF_INET6. Blocking others reduces kernel attack surface.',
  ...
  static HardeningAdvice getAdvice(String directiveRaw) {
    ...
    return _matrix[baseDirective] ??
        HardeningAdvice(
          tier: 3,
          directive: baseDirective,
          humanQuestion:
              'Should we restrict the system access controlled by $baseDirective?',
          humanAdvice:
              'We do not have simple advice for this directive. It is an advanced feature. Please check the Systemd Reference for detailed documentation.',
          snippet: r'$baseDirective=...',
        );
  }
}
